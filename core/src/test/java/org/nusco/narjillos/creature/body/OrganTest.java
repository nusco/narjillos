...
public abstract class OrganTest extends BodyPartTest {
	...
	public void knowsItsChildren() {
		Organ r = getBodyPart();
		Organ child1 = r.addChild(new BodySegment(20, 10, new ColorByte(100), r, new DelayNerve(0), 45, 0));
		Organ r1 = getBodyPart();
		Organ child2 = r1.addChild(new BodySegment(20, 10, new ColorByte(100), r1, new DelayNerve(0), -45, 0));
	...
	public void sproutsOrgans() {
		Organ r = getBodyPart();
		BodyPart child = r.addChild(new BodySegment(20, 12, new ColorByte(100), r, new DelayNerve(0), 45, 0));
