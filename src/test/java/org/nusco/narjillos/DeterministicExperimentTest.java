...
public class DeterministicExperimentTest {
	...
	public static void runTest(int cycles) {
		...
		Experiment experiment1 = new Experiment(1234, new Ecosystem(Configuration.ECOSYSTEM_BLOCKS_PER_EDGE_IN_APP * 1000, false), "deterministic_experiment_test", false);
